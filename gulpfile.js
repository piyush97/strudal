/**
 * Gulp file to automate the various tasks for Slika, By @Piyush97 
 */
// The Unused will be used soon do not comment em' out, By Piyush97
...
gulp.task('minify:js', function(cb) {
    return gulp.src([
            paths.src.base + '/assets/js/slika.js'
        ])
        .pipe(uglify())
        .pipe(rename({ suffix: '.min' }))
...
gulp.task('copy:css', function() {
    return gulp.src([
        paths.src.base + '/assets/css/slika.css'
    ])
    .pipe(gulp.dest(paths.dist.base + '/css'))
});
